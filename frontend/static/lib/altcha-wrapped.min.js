...
(function() {
    ...
    var na = Yn('<div class="altcha-checkbox"><input/> <svg aria-hidden="true" width="12" height="9" viewBox="0 0 12 9"><polyline points="1 5 4 8 11 1"></polyline></svg> <div class="altcha-spinner altcha-checkbox-spinner" aria-hidden="true"></div></div>');
    ...
    var aa = Yn('<div class="altcha-checkbox-native"><input/> <div class="altcha-spinner altcha-checkbox-native-spinner"></div></div>');
    ...
    var sa = Yn('<div class="altcha-footer"><p></p> <!></div>');
    ...
    var ua = Yn('<div class="altcha-switch"><input/>  <div class="altcha-switch-toggle"><div class="altcha-spinner altcha-switch-spinner"></div></div></div>');
    ...
    var da = (e => (e.ERROR = "error", e.LOADING = "loading", e.PLAYING = "playing", e.PAUSED = "paused", e.READY = "ready", e))(da || {}),
        ...
        pa = Yn('<div class="altcha-code-challenge-title"> </div>'),
        va = Yn('<div class="altcha-spinner"></div>'),
    ...
    var _a = Yn('<div class="altcha-popover-backdrop" data-backdrop=""></div>'),
        $a = Yn('<div class="altcha-popover-arrow"></div>'),
        Sa = Yn('<div role="button" class="altcha-popover-close">&times;</div>'),
        Ca = Yn('<!> <div><!> <!> <div class="altcha-popover-content"><!></div></div>', 1);
    ...
    var Ia = Yn('<div class="altcha-overlay-backdrop" data-backdrop=""></div>'),
        Pa = Yn('<div class="altcha-overlay-content"></div>'),
        Oa = Yn('<div role="button" class="altcha-overlay-close">&times;</div> <!>', 1),
        Ra = Yn('<div class="altcha-floating-arrow"></div>'),
        La = Yn('<input type="hidden"/>'),
        Ma = Yn('<div class="altcha-error">Secure context (HTTPS) required.</div>'),
        Da = Yn('<div class="altcha-error"> </div>'),
        Ua = Yn('<div class="altcha-error"> </div>'),
        Va = Yn("<!> <!>", 1),
        Na = Yn('<!> <div class="altcha"><!> <div class="altcha-main"><div><div class="altcha-checkbox-wrap"><!> <label><!></label></div> <!></div> <!> <!> <!></div> <!></div>', 1);
    "undefined" != typeof window && window.customElements && !customElements.get("altcha-widget") && customElements.define("altcha-widget", ta(function(e, t) {
        ...
        async function we(e) {
            ...
            if (ln(L).verifyUrl) t = await async function(e, t) {
                ...
                return a && "object" == typeof a && "payload" in a && a.payload && h("serververification", a), a
            }(ln(A), e);
            else {
                if (!ln(L).verifyFunction) return void Te(ha.ERROR, "Parameter verifyUrl is required for code challenge verification.");
                t = await ln(L).verifyFunction(ln(A), e)
            }
            t?.payload && (Et(A, t.payload, !0), _e("server payload", ln(A))), !0 === t?.verified ? (_e("verified"), Te(ha.VERIFIED), h("verified", {
                payload: ln(A)
            }), "onsubmit" === ln(U) && on().then(() => {
                ve(ln(S))
