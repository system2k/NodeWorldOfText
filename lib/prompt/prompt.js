...
var events = require('events'),
    ...
    utile = require('./utile/index.js'),
    async = utile.async,
    read = require('./read.js'),
    validate = require('./revalidator.js').validate,
...
//
require('./pkginfo.js')(module, 'version');
...
prompt.getInput = function (prop, callback) {
  ...
  read({
    ...
    tmp = [];
  }, function(rl, done, line) {
    prompt.rl = rl;
    prompt.execDone = done;
    prompt.execOnLine = line;
  });
};
