...
Object.defineProperties(utile, {
  ...
  'async': {
    get: function() {
      return utile.async = require('../async.js');
    }
  },
  ...
  'inflect': {
    get: function() {
      return utile.inflect = require('../i/inflect.js')();
    }
  },
  ...
  'mkdirp': {
    get: function() {
      return utile.mkdirp = require('../mkdirp.js');
    }
  },
  ...
  'deepEqual': {
    get: function() {
      return utile.deepEqual = require('../deep-equal.js');
    }
  },
  ...
  'rimraf': {
    get: function() {
      return utile.rimraf = require('../rimraf.js');
    }
  },
  ...
  'cpr': {
    get: function() {
      return utile.cpr = require('../ncp.js').ncp;
    }
  },
